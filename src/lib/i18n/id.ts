export const id = {
	...
	'preview.page': 'Halaman {n} dari {total}',
	'preview.confidential': 'RAHASIA',
	...
	'activity.appendOnly': 'Hanya-tambah. Tidak ada entri yang bisa diubah atau dihapus.',
	'activity.you': 'Anda',
	'activity.seed.created': 'membuat ruang data “{room}”',
	'activity.seed.template': 'menambahkan 22 folder sekaligus dari template Due diligence M&A',
	'activity.seed.invite': 'mengundang {email} sebagai Tamu di grup {group}, akses sampai {date}',
	...
	'qa.desc':
		'Setiap grup hanya melihat pertanyaannya sendiri. Anda menjawab dari satu antrean, lalu memilih jawaban mana yang layak jadi FAQ untuk semua grup, tanpa identitas penanya.',
	'qa.sees': 'Yang dilihat {who}',
	'qa.owner': 'Anda (Pemilik)',
	'qa.status.waiting': 'Menunggu',
	'qa.status.answered': 'Dijawab',
	'qa.status.closed': 'Ditutup',
	'qa.from': 'dari {group}',
	'qa.faq': 'FAQ',
	'qa.faqNote': 'FAQ tampil untuk semua grup tanpa identitas penanya.',
	'qa.export': 'Ekspor CSV',
	'qa.quota': 'Kuota per grup',
	'qa.q1': 'Apakah proyeksi 2027 sudah memasukkan kontrak PT Nusantara Distribusi?',
	'qa.a1': 'Sudah. Kontrak itu masuk sejak Q2 2026. Lihat Keuangan › Proyeksi, halaman 4.',
	'qa.q2': 'Siapa pemegang saham yang belum menandatangani perjanjian pemegang saham 2024?',
	'qa.q3': 'Kapan sertifikat merek “Cendana” terakhir diperpanjang?',
	'qa.a3': 'Maret 2026, berlaku sampai 2036. Salinannya ada di Kekayaan intelektual.',
	'qa.faqQ': 'Apakah laporan keuangan FY2023–FY2025 sudah diaudit?',
	'qa.faqA': 'Ya. Ketiganya diaudit oleh KAP independen dengan opini wajar tanpa modifikasian.',
	...
	'tpl.desc':
		'Lima template bawaan, satu per jenis deal. Template menambahkan folder ke ruang Anda; tidak pernah mengganti yang sudah ada.',
	'tpl.folders': '{n} folder',
	'tpl.structure': 'Struktur folder',
	'tpl.apply': 'Terapkan — {n} folder baru',
	'tpl.pick': 'Pilih template',

	'life.title': 'Satu ruang, tiga keadaan.',
	'life.desc':
		'Ruang lahir dalam Persiapan, dibuka ke tamu saat Aktif, lalu dibekukan sebagai Arsip. Arsip bisa diaktifkan kembali.',
	'life.status': 'Status',
	'life.prepare': 'Persiapan',
	'life.prepare.hint': 'Ruang masih disiapkan. Tamu belum dapat membukanya.',
	'life.prepare.body':
		'Susun folder, unggah dokumen, buat grup, atur izin. Tamu yang mencoba masuk ditolak.',
	'life.active': 'Aktif',
	'life.active.hint': 'Ruang aktif. Pihak dengan akses dapat membukanya.',
	'life.active.body':
		'Undang tamu lewat email ke satu grup, dengan atau tanpa batas masa akses. Setiap pembukaan tercatat.',
	'life.archive': 'Arsip',
	'life.archive.hint': 'Ruang menjadi hanya-baca untuk semua peran, termasuk Anda.',
	'life.archive.body':
		'Tamu tetap dapat membaca, tetapi unduhan dimatikan dan setiap halaman diberi watermark. Paket arsip: ZIP seluruh ruang berikut CSV aktivitas, tautan berlaku 30 hari.',
	'life.guests': '{n} tamu',
	'life.guestsNone': 'belum ada tamu',
	'life.package': 'Paket arsip',
	'life.packageMeta': '{n} dokumen · kedaluwarsa {date}',

	'sec.title': 'Yang kami lakukan. Yang tidak kami klaim.',
	...
	'sec.do.4.t': 'Terenkripsi saat diam',
	'sec.do.4.b':
		'Penyimpanan objek memakai AES-256 (SSE-S3) dan diverifikasi setiap kali server dinyalakan. Kunci dipegang penyedia penyimpanan.',
	'sec.do.5.t': 'Disimpan di Jakarta',
	...
	'sec.dont.3.t': 'Membaca di ponsel',
	'sec.dont.3.b': 'Viewer tidak disajikan di layar di bawah 768×480. Tamu membaca di laptop.',
	'sec.dont.4.t': 'PDF ber-watermark yang ringan',
	'sec.dont.4.b':
	...
	'faq.metaDescription':
		'Jawaban singkat tentang ruang data Rakda: apa itu, cara memulai, izin akses, keamanan, pelacakan, uji coba, dan apa yang terjadi setelah deal selesai.',
	'faq.title': 'Pertanyaan umum',
	'faq.index': 'Daftar isi',
	'faq.count': '{n} pertanyaan',
	'faq.proof': 'Dibuktikan di',
	'faq.permalink': 'Tautan ke pertanyaan {n}',
	'faq.ref.grid': 'Kisi izin',
	'faq.ref.qa': 'Q&A',
	'faq.ref.engagement': 'Aktivitas',
